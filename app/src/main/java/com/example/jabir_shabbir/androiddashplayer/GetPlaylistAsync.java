...
public class GetPlaylistAsync extends AsyncTask<String[], Integer, Void>
{
    ...
    public GetPlaylistAsync(String uri, Context context)
    {
    ...
    {
        Log.i("DASHPlayer" , "Inside doInBackground of GetPlaylistAsync");
